...
$loader->addPsr4('CarrooiTests\\FavoritesApp\\', __DIR__ . '/../');
...
$config->addConfig(__DIR__. '/../config/config.associations.neon');
$config->addConfig(FileMock::create('parameters: {databasePath: %appDir%/Model/database_associations}', 'neon'));
